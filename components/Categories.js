...
const Categories = () => {
    const categories = [
        {id:1,image: 'https://images.prismic.io/frameworkmarketplace/46cbf974-cdff-4cd8-b761-8b4a3343f6c4_FW-chromebook-homepage-carousel.png?auto=compress,format',title:'Laptop'},
