        ...
        <TouchableWithoutFeedback onPress={() => {
            ...
            <View className="relative">
                ...
                <Animated.View className="mt-20 px-6">
                    <Text className="text-lg font-semibold text-gray-400">Email</Text>
                    ...
                    <TouchableOpacity className="bg-[#FCB424] mb-12" style={styles.commandButton} onPress={handleUpdate}>
